...
<body onload="slide1()">
        ...
        <div class="info">
            ...
            <div class="sell">
                <img src="./res/assets/piscina com equipo.jpg" alt="">
                <div class="infos">
                    <p class="title">VENDA DE EQUIPAMENTOS</p>
                    <p>Trabalhamos com as melhores marcas do mercado.</p>
                    <a href="/venda-equipamentos">Saiba Mais</a>
                </div>
            </div>
        </div>
        ...
        <div class="contact">
            <p>Contato: </p><br>
            <p><a href="mailto:scubatuba@scubatuba.com.br" style="text-decoration: none; color: #ffff;">scubatuba@scubatuba.com.br</a></p><br>
    ...
    <div class="location">
        <p>Nosso Embarque</p>
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3660.220842312391!2d-45.049125585024306!3d-23.452497184737002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94cd5320cc8803cd%3A0x211958f1659e9456!2sPosto%20Mar%C3%ADtimo%20Rede%20Mar!5e0!3m2!1spt-BR!2sbr!4v1576964172530!5m2!1spt-BR!2sbr" 
    width="800" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe></div>

    <div class="footer">
        <p>Designed By João Juliasz de Morais</p>
        <div class="scubaSchool">
        <img src="./res/assets/padi.png" class="padi" alt="">
