...
<script>
    ...
    function slide1() {
        document.getElementById("banner").src = "./res/assets/anchieta 2.jpg"
        setTimeout("slide2()", intervalo)
    }
    function slide2() {
        document.getElementById("banner").src = "./res/assets/praia-cedro.jpg"
        setTimeout("slide3()", intervalo)
    }
    function slide3() {
        document.getElementById("banner").src = "./res/assets/barco 4.jpg"
        setTimeout("slide4()", intervalo)
    }
    function slide4() {
        document.getElementById("banner").src = "./res/assets/anchieta.jpg"
