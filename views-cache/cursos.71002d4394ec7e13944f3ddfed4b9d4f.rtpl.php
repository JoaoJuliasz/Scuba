...
<div class="inside">
    <img src="./res/assets/aula piscina casa.jpg" alt="">
    ...
    <p> Duração: 2 horas. <br>
        ...
        Valor: R$200.<br>
        <br>
        Inclui: aluguel de todo equipamento e instrutor.</p><br></div>
    ...
    <p> Duração: 2 dias e meio.<br>
        ...
        <br>
        * Geralmente o mergulho noturno é feito no píer.</p><br></div>
    ...
    <p> Duração: 1 dia. <br>
        ...
        <br>
        Não há limite de idade mínima.</p> <br></div>
    ...
    <p id="hide7"> Perda de 50% do valor total para cancelamentos 5 dias antes da saída.<br>
        <br>
        Perda de 100% do valor total para o não comparecimento.</p><br>

    <p class="subtitle" onclick="hide8()"><u>Reembolsos</u></p> <br>

    <p id="hide8"> Ocorre quando a saída for cancelada por motivos alheios a nossa vontade, como problemas mecânicos ou<br>
        climáticos.<br>
        <br>
